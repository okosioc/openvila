...
function commandSuggestions(locale) {
  return [
    ...
    { cmd: "/vila install https://petdex.dev/pets/<slug>", desc: pick(locale, "下载并激活 Petdex 精灵", "download and activate a Petdex vila") },
    { cmd: "/vila disable", desc: pick(locale, "停用当前精灵", "disable the active vila") },
    { cmd: "/vila delete <slug>", desc: pick(locale, "删除已安装精灵", "delete an installed vila") },
