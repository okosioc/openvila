  ...
  const messages = [
    {
      ...
      content: [
        ...
        "(3) If the user's question can be answered confidently and completely using Frequent Customer Concerns context, set can_answer_directly=true, provide direct_answer in the user's language, and doc_paths=[]. When Frequent Customer Concerns context contains a relevant Markdown link, use its exact URL in a Markdown link with text that fits direct_answer. Never output a provided URL as bare text, never invent URLs, never include internal document paths such as docs/... in direct_answer.",
  ...
  const messages = [
    {
      ...
      content: [
        ...
        "(2) When selected documents contain a relevant complete Markdown link, use its exact URL in a Markdown link with text that fits your answer. Never output a provided URL as bare text, never invent URLs, never include internal document paths such as docs/... in your answer.",
